"""Sync patched pipeline.py to runtime, then re-run the int4-only quant."""
...
LOCAL = r"C:\Users\Zwmar\projects\ICS\ics\pipeline.py"
REMOTE = "/content/ICS/ics/pipeline.py"
