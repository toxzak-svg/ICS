"""Sync the new gptq.py module to the runtime."""
import sys, base64
...
LOCAL = r"C:\Users\Zwmar\projects\ICS\ics\gptq.py"
REMOTE = "/content/ICS/ics/gptq.py"
...
import sys
if "ics.gptq" in sys.modules:
    del sys.modules["ics.gptq"]
"""
r = c.exec(script)
print(r.stdout)
if r.error:
